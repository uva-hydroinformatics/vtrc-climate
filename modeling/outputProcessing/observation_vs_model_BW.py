...
#                            end_data_utc, directory, grid_res, run_version):
    ...
    ax.plot(y_output_original, '-s', markevery=80, color='g', label='30m NEW DEM & flow network') #Dataset C
    # ax.plot(y_output_hr, '-.o', markevery=80, color='Purple', label='30m new DEM No Gully') #Dataset D
    # ax.plot(y_output_sv,'--x', markevery=80, color='Blue', label='30m new DEM') #Dataset E
    ax.plot(y_output, '-^', markevery=80, color='r', label='30m New DEM only') #Dataset B
...
output_file = "VU_30m_HPC_GPU_Nicole_2016_gauges_BWND_HQ_b_newDEM_only_PO.csv"
...
output_file_original = "VU_30m_HPC_GPU_Nicole_2016_gauges_BWND_HQ_b_045_newDEM_PO.csv"

# locate the model version applying HT Fixed #Dataset D
output_file_hr = "VU_30m_HPC_GPU_Nicole_2016_gauges_BWND_HQ_b_045_newDEM_nogully_PO.csv"
