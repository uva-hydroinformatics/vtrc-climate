...
PDSRain <- function(Years){
  ...
  threshold <- 65 # lower threshold for 1-year return period (mm) for the selected station
...
output_IDF <- file(paste0(dirc,"CanESM2_CanRCM4_BiasCorrected_Historical_IDF.csv"))
